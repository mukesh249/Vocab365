...
public class QuestionSlideAdapter extends RecyclerView.Adapter<QuestionSlideAdapter.MyViewHolder> implements Filterable {
    ...
    public QuestionSlideAdapter(Context context, List<QuestionModel> feedsListall, ViewPager pager, DrawerLayout drawer,String qua_ser[]) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (qua_ser[position].compareTo("0")!=0){
            holder.tv_num.setBackground(context.getResources().getDrawable(R.drawable.small_gray_outline_circle_selected));
            holder.tv_num.setTextColor(context.getResources().getColor(R.color.white));
            holder.tv_direction.setTextColor(context.getResources().getColor(R.color.colorPrimary));
        }else {
            holder.tv_num.setBackground(context.getResources().getDrawable(R.drawable.small_gray_outline_circle));
            holder.tv_num.setTextColor(context.getResources().getColor(R.color.black));
            holder.tv_direction.setTextColor(context.getResources().getColor(R.color.black));
        }
        holder.tv_num.setText(feeds.getNumber());
        holder.qus_quiz_slide.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private LinearLayout qus_quiz_slide;
        ...
        public MyViewHolder(View itemView) {
            ...
            qus_quiz_slide = (LinearLayout)itemView.findViewById(R.id.qus_quiz_slide);
