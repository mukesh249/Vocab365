...
public class FetchAddressIntentService extends IntentService {
    ...
    private static final String LOGTAG = FetchAddressIntentService.class.getName();
    /**
    ...
    public FetchAddressIntentService() {
        // Use the LOGTAG to name the worker thread.
        super(LOGTAG);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (mReceiver == null) {
            Log.v(LOGTAG, "No receiver received. There is nowhere to send the results.");
            return;
        }
        ...
        if (location == null) {
            errorMessage = "No Location data enable";
            Log.v(LOGTAG, errorMessage);
